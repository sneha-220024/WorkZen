...
export default function Attendance() {
    ...
    const fetchAttendance = async () => {
        try {
            ...
            if (!token) return;
            const res = await axios.get('http://localhost:5005/api/employee/attendance/history', {
    ...
    const handleCheckIn = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                'http://localhost:5005/api/employee/attendance/check-in',
                {},
                { headers: { Authorization: `Bearer ${token}` } }
            );
    ...
    const handleCheckOut = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                'http://localhost:5005/api/employee/attendance/check-out',
                {},
                { headers: { Authorization: `Bearer ${token}` } }
            );
