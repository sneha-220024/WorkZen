        ...
        try {
            ...
            if (user.role === 'hr') {
                ...
                const [attendanceRes, leavesRes] = await Promise.all([
                    axios.get('http://localhost:5005/api/employee/attendance/history', config).catch(() => ({ data: { success: false, data: [] } })),
                    axios.get('http://localhost:5005/api/employee/leaves/history', config).catch(() => ({ data: { success: false, data: [] } }))
                ]);
